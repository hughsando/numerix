...
static NNP_INLINE void winograd_f6k3_input_transform(
	...
	psimd_f32 transform0[RESTRICT 1],
	psimd_f32 transform1[RESTRICT 1],
	psimd_f32 transform2[RESTRICT 1],
	psimd_f32 transform3[RESTRICT 1],
	psimd_f32 transform4[RESTRICT 1],
	psimd_f32 transform5[RESTRICT 1],
	psimd_f32 transform6[RESTRICT 1],
	psimd_f32 transform7[RESTRICT 1])
{
...
static NNP_INLINE void winograd_f6k3_output_transform(
	...
	psimd_f32 output0[RESTRICT 1],
	psimd_f32 output1[RESTRICT 1],
	psimd_f32 output2[RESTRICT 1],
	psimd_f32 output3[RESTRICT 1],
	psimd_f32 output4[RESTRICT 1],
	psimd_f32 output5[RESTRICT 1])
{
	/*

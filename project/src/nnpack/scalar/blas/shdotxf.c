...
void nnp_shdotxf2__scalar(
	const float x[RESTRICT 1],
	const uint16_t y[RESTRICT 2],
	size_t stride_y,
	float sum[RESTRICT 2],
	size_t n)
{
	float acc0, acc1;
	acc0 = acc1 = 0.0f;
...
void nnp_shdotxf3__scalar(
	const float x[RESTRICT 1],
	const uint16_t y[RESTRICT 3],
	size_t stride_y,
	float sum[RESTRICT 3],
	size_t n)
{
...
void nnp_shdotxf4__scalar(
	const float x[RESTRICT 1],
	const uint16_t y[RESTRICT 4],
	size_t stride_y,
	float sum[RESTRICT 4],
	size_t n)
{
...
void nnp_shdotxf5__scalar(
	const float x[RESTRICT 1],
	const uint16_t y[RESTRICT 5],
	size_t stride_y,
	float sum[RESTRICT 5],
	size_t n)
{
...
void nnp_shdotxf6__scalar(
	const float x[RESTRICT 1],
	const uint16_t y[RESTRICT 6],
	size_t stride_y,
	float sum[RESTRICT 6],
	size_t n)
{
...
void nnp_shdotxf7__scalar(
	const float x[RESTRICT 1],
	const uint16_t y[RESTRICT 7],
	size_t stride_y,
	float sum[RESTRICT 7],
	size_t n)
{
...
void nnp_shdotxf8__scalar(
	const float x[RESTRICT 1],
	const uint16_t y[RESTRICT 8],
	size_t stride_y,
	float sum[RESTRICT 8],
	size_t n)
{
